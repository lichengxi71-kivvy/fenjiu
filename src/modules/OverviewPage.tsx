      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-12">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card xl:col-span-4">
          ...
          <div className="h-64">
            <ResponsiveContainer>
              <PieChart>
                <Pie data={brandStructure} dataKey="value" nameKey="name" innerRadius={62} outerRadius={95}>
                  {brandStructure.map((entry, index) => (
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
            ...
            <div className="space-y-3">
              {overviewAlerts.map((item) => (
                <div key={item.id} className="rounded-xl border border-slate-100 bg-paper p-3">
